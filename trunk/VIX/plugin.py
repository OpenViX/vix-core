	...
	def go(self):
		...
		if current:
			...
			if self.menu == 0:
				...
				elif (currentEntry == "software-update-offline"):
					self.session.openWithCallback(self.runUpgradeOffline, MessageBox, _("Do you want to update your Receiver?")+"\n"+_("The screen will go blank while upgrading, be patient and wait for the reboot."))
