...
class ImageManagerDownload(Screen):
	...
	def __init__(self, session, BackupDirectory, ConfigObj):
		Screen.__init__(self, session)
		self.setTitle(_("%s downloads") % {config.imagemanager.imagefeed_ATV: "OpenATV", config.imagemanager.imagefeed_Pli: "OpenPLi", config.imagemanager.imagefeed_ViX: "OpenViX", config.imagemanager.imagefeed_OBH, config.imagemanager.imagefeed_OV: "Open Vision", config.imagemanager.imagefeed_MyBuild: "My build"}.get(ConfigObj, ''))
