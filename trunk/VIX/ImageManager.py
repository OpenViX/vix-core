	...
	def doResstore(self, answer):
		...
		if answer is True:
			if boxtype == "vusolo" or boxtype == "vuduo":
				...
				mycmd11 = 'flash_eraseall -j /dev/mtd0'
				mycmd12 = 'flash_eraseall -j /dev/mtd1'
				mycmd13 = 'flash_eraseall -j /dev/mtd2'
				mycmd14 = "echo ' '"
				mycmd15 = "echo 'Flasing Image to NAND.'"
				mycmd16 = "echo ' '"
				mycmd17 = NANDWRITE + ' -p /dev/mtd0 ' + BACKUP_DIRECTORY + '/' + selectedimage + '/vuplus/' + boxtype + '/root_cfe_auto.jffs2'
				mycmd18 = NANDWRITE + ' -p /dev/mtd1 ' + BACKUP_DIRECTORY + '/' + selectedimage + '/vuplus/' + boxtype + '/kernel_cfe_auto.bin'
				mycmd19 = NANDWRITE + ' -p /dev/mtd2 ' + BACKUP_DIRECTORY + '/' + selectedimage + '/vuplus/' + boxtype + '/boot_cfe_auto.jffs2'
				...
				mycmd12 = 'flash_eraseall -j /dev/mtd1'
				mycmd13 = 'flash_eraseall -j /dev/mtd2'
				mycmd14 = 'flash_eraseall -j /dev/mtd3'
				mycmd15 = "echo ' '"
				mycmd16 = "echo 'Flasing Image to NAND.'"
				mycmd17 = "echo ' '"
				mycmd18 = NANDWRITE + ' -p /dev/mtd0 ' + BACKUP_DIRECTORY + '/' + selectedimage + '/vuplus/' + boxtype + '/root_cfe_auto.jffs2'
				mycmd19 = NANDWRITE + ' -p /dev/mtd1 ' + BACKUP_DIRECTORY + '/' + selectedimage + '/vuplus/' + boxtype + '/kernel_cfe_auto.bin'
				mycmd20 = NANDWRITE + ' -p /dev/mtd2 ' + BACKUP_DIRECTORY + '/' + selectedimage + '/vuplus/' + boxtype + '/boot_cfe_auto.jffs2'
				...
				mycmd9 = "echo 'Preparing Flashprogress.'"
				mycmd10 = "echo 'Erasing NAND Flash.'"
				mycmd11 = 'flash_eraseall -j /dev/mtd1'
				mycmd12 = 'flash_eraseall -j /dev/mtd2'
				mycmd13 = 'flash_eraseall -j /dev/mtd3'
				mycmd14 = "echo ' '"
				mycmd15 = "echo 'Flasing Image to NAND.'"
				mycmd16 = "echo ' '"
				mycmd17 = NANDWRITE + ' -p /dev/mtd1 ' + BACKUP_DIRECTORY + '/' + selectedimage + boxtype + '/kernel.bin'
				mycmd18 = NANDWRITE + ' -p /dev/mtd2 ' + BACKUP_DIRECTORY + '/' + selectedimage + boxtype + '/boot.bin'
				mycmd19 = NANDWRITE + ' -p /dev/mtd3 ' + BACKUP_DIRECTORY + '/' + selectedimage + boxtype + '/rootfs.bin'
				mycmd20 = "echo 'Flasing Complete.'"
				mycmd21 = 'sleep 2'
				mycmd22 = 'shutdown -r now'
				self.session.open(Console, title='Creating Image...', cmdlist=[mycmd1, mycmd2, mycmd3, mycmd4, mycmd5, mycmd6, mycmd7, mycmd8, mycmd9, mycmd10, mycmd11, mycmd12, mycmd13, mycmd14, mycmd15, mycmd16, mycmd17, mycmd18, mycmd19, mycmd20, mycmd21, mycmd22],closeOnSuccess = True)
